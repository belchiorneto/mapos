    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <i class="fas fa-user"></i>
                ...
                <div class="buttons">
                    <a title="Voltar" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/fornecedores"><i
    ...
    echo '<div class="alert alert-danger">' . $custom_error . '</div>';
                    ...
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="nomeFornecedor" type="text" name="contato"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label for="cliente" class="btn btn-default" style="margin-top: 5px;">Cliente
                                    <input type="checkbox" id="cliente" name="cliente" class="badgebox"
                                           value="1" <?= ($result->cliente == 1) ? 'checked' : '' ?>>
