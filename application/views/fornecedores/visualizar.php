<div class="widget-box">
    ...
    echo '<a title="Icon Title" class="btn btn-mini btn-info" href="' . base_url() . 'index.php/fornecedores/editar/' . $result->idFornecedores . '"><i class="fas fa-edit"></i> Editar</a>';
                ...
                <a title="Voltar" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/fornecedores"><i class="fas fa-arrow-left"></i> Voltar</a>
            </div>
        </ul>
    </div>
                    ...
                    <div class="collapse in accordion-body" id="collapseGOne">
                        <div class="widget-content">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Tipo do Fornecedor</strong></td>
                                    <td>
                                        <?php echo $result->fornecedor == true ? 'Fornecedor' : 'Fornecedor'; ?>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
