...
class Fornecedores extends MY_Controller
{
    ...
    public function excluir()
    {
        ...
        $os = $this->fornecedores_model->getAllOsByClient($id);
        if ($os != null) {
            $this->fornecedores_model->removeClientOs($os);
        }

        // excluindo Vendas vinculadas ao fornecedor
        $vendas = $this->fornecedores_model->getAllVendasByClient($id);
        if ($vendas != null) {
            $this->fornecedores_model->removeClientVendas($vendas);
        }
